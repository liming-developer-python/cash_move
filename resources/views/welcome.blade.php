        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
                    <div class="intro-img">
                        <img class="img-fluid" src="{{ asset('img/intro-mobile.png') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<section id="team" class="section-padding bg-gray">
    <div class="container">
        <div class="section-header text-center">
            <h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">BENEFICIO</h2>
            <div class="shape wow fadeInDown" data-wow-delay="0.3s"></div>
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-2 col-xs-2"></div>
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 col-xs-12">
                <div class="services-item wow row fadeInRight" data-wow-delay="0.3s">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-xs-12">
                <iframe width="100%" height="450px" src="https://www.youtube.com/embed/tgbNymZ7vqY">
                </iframe>
            </div>
        </div>
    </div>
                ...
                <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{ asset('img/testimonial/img1.jpg') }}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{ asset('img/testimonial/img3.jpg') }}" alt="">
                            </div>
                            <div class="info">
                    ...
                    <div class="item">
                        <div class="testimonial-item">
                            <div class="img-thumb">
                                <img src="{{ asset('img/testimonial/img4.jpg') }}" alt="">
                            </div>
                            <div class="info">
